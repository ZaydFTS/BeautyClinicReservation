      ...
      {value && (
        <div className="group relative rounded-lg border border-border/60 overflow-hidden">
          ...
          <button
            type="button"
            onClick={() => onChange("")}
            className="absolute top-1 right-1 flex h-6 w-6 items-center justify-center rounded-full bg-rose-500 text-white opacity-0 transition-opacity group-hover:opacity-100 hover:bg-rose-600"
            aria-label="Remove"
          >
