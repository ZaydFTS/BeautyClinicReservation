...
export function ServiceDetailPage({ route }: { route: Extract<Route, { name:"service_detail" }> }) {
 ...
 <div className="relative overflow-hidden rounded-2xl border border-outline-variant/70 bg-blush">
 {/* Layered decorative orbs */}
 <div
 className="pointer-events-none absolute -right-16 -top-16 h-48 w-48 rounded-full bg-primary/15"
 aria-hidden
 />
 <div
 className="pointer-events-none absolute -bottom-20 -left-12 h-56 w-56 rounded-full bg-blush"
 aria-hidden
 />
 {/* Sparkles accents */}
 <Sparkles className="pointer-events-none absolute right-6 top-6 h-16 w-16 text-primary-container/50" aria-hidden />
 <Sparkles className="pointer-events-none absolute bottom-8 left-6 h-10 w-10 text-primary/60" aria-hidden />
 {/* Subtle dot pattern */}
 <div
 ...
 <Badge
 variant="outline"
 className="mb-4 border-white/60 bg-white/70 px-3 py-1 text-xs font-medium text-secondary shadow-sm backdrop-blur-md"
 >
 {svc.category}
 </Badge>
 ...
 <Card className="mt-4 bg-blush">
 <CardContent className="p-4">
 <div className="flex items-start gap-2 text-sm">
 <ShieldCheck className="mt-0.5 h-4 w-4 flex-shrink-0 text-primary" />
 <div>
 <strong className="text-secondary">{t("serviceDetail.bookingEasy")}</strong>{""}
