...
export function ContactPage() {
 ...
 <Label htmlFor="name">{t("contact.name")} <span className="text-primary">{t("contact.required")}</span></Label>
 <Input
 id="name"
 value={form.name}
 ...
 <div className="space-y-2">
 <Label htmlFor="message">{t("contact.message")} <span className="text-primary">{t("contact.required")}</span></Label>
 <Textarea
 id="message"
 rows={6}
 value={form.message}
