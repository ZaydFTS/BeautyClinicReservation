  ...
  if (items.length === 0) {
    return (
      <div className="mx-auto max-w-4xl px-4 py-16 text-center">
        ...
        <Button
          size="lg"
          className="btn-shimmer mt-6 w-full bg-gradient-to-r from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-700 sm:w-auto"
    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-3">
          {items.map((item) => (
            <Card key={item.productId} className="card-hover overflow-hidden rounded-xl border-rose-100/70 shadow-sm transition-all duration-200 hover:border-rose-200 hover:shadow-md hover:shadow-rose-500/5">
              <CardContent className="flex items-center gap-3 p-3 sm:gap-4 sm:p-4">
                <div className="h-14 w-14 flex-shrink-0 overflow-hidden rounded-lg bg-gradient-to-br from-rose-100 to-amber-50 ring-1 ring-rose-100 sm:h-16 sm:w-16">
                  {item.imageUrl ? (
        ...
        <div>
          <Card className="sticky top-20 border-rose-100/70 shadow-sm">
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div className="flex items-end justify-between border-t border-rose-100 pt-3">
                <span className="font-semibold">{t("cart.total")}</span>
                <span className="text-gradient-rose text-2xl font-bold tracking-tight">{formatMoney(total)}</span>
              </div>
              <div className="rounded-lg bg-gradient-to-br from-rose-50 to-amber-50/40 p-3 text-xs text-rose-700 ring-1 ring-rose-100/60">
