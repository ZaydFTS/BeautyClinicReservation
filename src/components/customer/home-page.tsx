            ...
            services.map((svc, i) => (
              ...
              >
                <CardHeader className="relative overflow-hidden bg-gradient-to-br from-rose-100 via-rose-50 to-amber-50/60 p-5">
                  ...
                  <div className="relative flex items-start justify-between gap-2">
                    ...
                    <div className="text-right">
                      <div className="text-gradient-rose text-lg font-bold tracking-tight">
                ...
                <CardContent className="p-5">
                  <CardTitle className="text-base font-semibold tracking-tight transition-colors group-hover:text-rose-700">
                    {svc.name}
                  </CardTitle>
                  {svc.description && (
                ...
                >
                  ...
                  <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-rose-100 via-rose-50 to-amber-50/60">
                    ...
                    <div className="absolute inset-x-3 bottom-3 flex translate-y-0 justify-end opacity-100 transition-all duration-300 sm:translate-y-2 sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100">
                      <span className="inline-flex h-9 items-center gap-1 rounded-full bg-white/90 px-3 text-xs font-semibold text-rose-700 shadow-lg shadow-rose-500/20 backdrop-blur-md">
                        View
