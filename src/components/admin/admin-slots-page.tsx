...
export function AdminSlotsPage() {
 ...
 isSelected ?"border-primary bg-blush text-secondary" :"hover:border-outline"
 }`}
 >
 ...
 <Badge variant="secondary" className="bg-blush text-secondary">
 {service.category}
 </Badge>
 </div>
 </CardHeader>
 ...
 appt
 ?"border-outline bg-blush"
 : slot.status ==="AVAILABLE"
 ?"border-outline-variant bg-blush"
...
function CreateSlotDialog({
 ...
 {selectedService && (
 <div className="rounded-md bg-blush p-2 text-xs text-secondary">
