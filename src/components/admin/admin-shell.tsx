...
function SidebarContent({ onNavigate }: { onNavigate?: () => void }) {
 ...
 <div className="truncate text-sm font-bold tracking-tight">{CLINIC_NAME.split("")[0]} {t("nav.book") ==="حجز" ?"إدارة" :"Admin"}</div>
...
export function AdminShell({ children }: { children: React.ReactNode }) {
 ...
 <div className="flex-1 font-semibold">{CLINIC_NAME.split("")[0]} {t("nav.book") ==="حجز" ?"إدارة" :"Admin"}</div>
 <LanguageSwitcher />
 </header>
