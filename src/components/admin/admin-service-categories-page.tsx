...
const COLOR_PRESETS = [
  ...
  "oklch(0.72 0.15 50)",  // peach
  "oklch(0.55 0.13 160)", // sage
  "oklch(0.78 0.16 80)",  // gold
  "oklch(0.50 0.20 310)", // orchid
  "oklch(0.55 0.02 350)", // neutral
]
              ...
              {COLOR_PRESETS.map((c) => (
                <button
                  ...
                  className={`h-8 w-8 rounded-full border-2 transition ${
                    color === c ? "border-rose-500 ring-2 ring-rose-200" : "border-border"
                  }`}
                  style={{ background: c }}
                  aria-label={`Color ${c}`}
                />
