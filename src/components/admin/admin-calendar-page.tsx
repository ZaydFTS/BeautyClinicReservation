...
export function AdminCalendarPage() {
 ...
 onClick={() => setView("day")}
 className={view ==="day" ?"bg-primary hover:bg-primary/90" :""}
 >
 ...
 className={view ==="month" ?"bg-primary hover:bg-primary/90" :""}
 >
 ...
 <div className="h-3 w-3 rounded bg-blush border border-outline" />
 ...
 <div className="flex items-center gap-1.5">
 <div className="h-3 w-3 rounded bg-blush-strong border border-outline" />
...
function MonthView({
 ...
 } ${isToday ?"border-outline bg-blush/50" :"border-border"}`}
 >
 <div className={`text-right text-xs ${isToday ?"font-bold text-primary" :"text-muted-foreground"}`}>
 {day.getDate()}
 </div>
 ...
 className={`truncate rounded px-1 py-0.5 text-[10px] text-primary bg-blush border border-dashed border-outline-variant ${
...
function WeekView({
 ...
 isToday ?"bg-primary text-white" :"bg-muted/50 text-muted-foreground"
 }`}>
 ...
 appt.status ==="BOOKED"
 ?"bg-blush text-secondary border border-outline-variant"
 : appt.status ==="COMPLETED"
 ?"bg-blush text-primary border border-outline-variant"
 ...
 ?"bg-blush text-primary border-outline-variant"
...
function DayView({
 ...
 <div className="rounded-lg bg-blush p-3 text-center">
 ...
 appt
 ? appt.status ==="BOOKED"
 ?"border-outline-variant bg-blush/50"
 : appt.status ==="COMPLETED"
 ?"border-outline-variant bg-blush/50"
 :"border-slate-200 bg-slate-50/50"
 : slot.status ==="AVAILABLE"
 ?"border-outline-variant bg-blush/30"
 :"border-slate-200 bg-slate-50/50"
 }`}
 >
